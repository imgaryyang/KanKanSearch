...
public class PaodingAnalyzerBean extends Analyzer {
	...
	public void setModeClass(String modeClass) {
		try {
			...
			throw new IllegalArgumentException("not found mode class:"
					+ e.getMessage());
		}
	}
	...
	protected TokenCollector createTokenCollector() {
		if (modeClass != null) {
			try {
				...
				throw new IllegalArgumentException("wrong mode class:"
						+ e.getMessage());
	...
	protected TokenStreamComponents createComponents(String text) {
		...
		PaodingTokenizer paodingTokenizer = new PaodingTokenizer(reader, knife,
				createTokenCollector());

		return new TokenStreamComponents(paodingTokenizer);
	}
}
